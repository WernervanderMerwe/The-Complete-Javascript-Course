...
const account2 = {
  ...
  movementsDates: [
    ...
    '2021-08-10T14:43:26.374Z',
    '2021-08-15T18:49:59.371Z',
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    const options = {
      ...
      year: 'numeric', // '2-digit', 'short', 'narrow'
      // weekday: 'long',
    };
...
console.log(65165498423168498135065498413298498n);
console.log(BigInt(651654984231684));

// Operations
console.log(10000n + 10000n);
console.log(32165649843213549816516549841n * 10000000n);
// console.log(Math.sqrt(16n));

const huge = 3516519851321651n;
const num = 23;
...
console.log(new Date('Aug 16 2021 14:48:37'));
